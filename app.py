...
if st.button("Hitung Kesamaan"):
    if not text1 or not text2:
        ...
        generate_wordcloud(text1, "Word Cloud Dokumen 1")
        generate_wordcloud(text2, "Word Cloud Dokumen 2")
        generate_wordcloud(combined_text, "Word Cloud Gabungan Dokumen")
